...
\begin{itemize}[label=\textcolor{red}{\textbullet}]
	...
	If $A\cap B=\emptyset$, then $\mathds{P}(A\cup B)=\mathds{P}(A)+\mathds{P}(B)$.
\end{itemize}
\begin{description}
	...
	\begin{itemize}[label=\textcolor{red}{\textbullet}]
		...
		\item $\mathds{P}(A\cup B\cup C)= \mathds{P}(A) + \mathds{P}(B\cap A^\mathsf{c}) + \mathds{P}(C\cap B^\mathsf{c}\cap A^\mathsf{c})$
	\end{itemize}
